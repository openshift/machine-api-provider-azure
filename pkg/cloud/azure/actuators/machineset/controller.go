...
func reconcile(machineSet *machinev1.MachineSet) (ctrl.Result, error) {
	...
	if !ok {
		return ctrl.Result{}, fmt.Errorf("unknown instance type: %s", providerConfig.VMSize)
	}
...
func getproviderConfig(machineSet *machinev1.MachineSet) (*providerconfigv1.AzureMachineProviderSpec, error) {
